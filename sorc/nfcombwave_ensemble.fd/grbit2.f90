! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
subroutine grbit2 (IFL2,nx,ny,lcgrib,bmp,fld,ierr,ymdc,fhr, &
                                     ensid,nprb,prbid,prblv,nensm) 
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
!
...
!
      ...
      real             :: FLD(nx*ny)
      real             :: coordlist(1)
      integer          :: pds(25),gds(22),parm,ensid,prbid,prblv,nensm
...
!
           ...
           igdstmpl(10) = 0
           igdstmpl(11) = 0
           igdstmpl(12) = 90000000      ! lat of first grid point
           igdstmpl(13) = 000           ! long of first grid point
           igdstmpl(14) = 48            ! res and comp flags
           igdstmpl(15) = -90000000     ! lat of last grid point
           igdstmpl(16) = 359000000     ! long of last grid point
           igdstmpl(17) = 1000000       ! Increment of lat
           igdstmpl(18) = 1000000       ! Increment of long
