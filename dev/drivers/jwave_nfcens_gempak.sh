...
export wave_nfcens_ver=v1.3
#export COMIN=/lfs/h2/emc/vpppg/noscrub/${USER}/nfcens_output
export COMOUT=/lfs/h2/emc/vpppg/noscrub/${USER}/nfcens_output
export DATAROOT=/lfs/h2/emc/ptmp/${USER}/nfcens_test
export jobid=jwave_nfcens_gempak_${PBS_JOBID}
